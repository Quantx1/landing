        ...
        <div className="space-y-8 text-[15px] leading-relaxed text-l-text-secondary">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>Provide, operate, and maintain the Quant X platform</li>
          ...
          <section>
            ...
            <p>Broker credentials are encrypted with AES-256. All communication occurs over HTTPS. Row-level security isolates every user&apos;s data. Access tokens are never stored in plain text.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-l-text mb-3">4. Third-Party Services</h2>
            <p>We integrate with a cloud database and authentication provider, Razorpay (payments), broker APIs (Zerodha, Angel One, Upstox), and a third-party AI inference provider. Each provider has its own privacy policy. We share only the minimum data required for each integration.</p>
          </section>
          ...
          <section>
            ...
            <p>You may access, correct, or delete your personal data through the Settings page. You can disconnect your broker account at any time, which immediately revokes our access. For any privacy concerns email <span className="text-primary">privacy@quantx.app</span>.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-l-text mb-3">7. Cookies</h2>
            <p>We use essential cookies for authentication (session tokens). We do not use third-party advertising cookies. Analytics cookies are optional and respect your browser&apos;s Do Not Track setting.</p>
          </section>
