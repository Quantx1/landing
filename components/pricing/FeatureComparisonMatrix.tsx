...
import { Check, ChevronDown, Minus } from '@/lib/icons'
...
const GROUPS: Group[] = [
  {
    ...
    rows: [
      ...
      { key: 'F1_intraday', feature: 'Intraday signals (F1) · Intraday', free: false, pro: true, elite: true },
      { key: 'F3_momentum', feature: 'Weekly momentum top-10 (F3)', free: false, pro: true, elite: true },
      { key: 'F8_regime', feature: 'Market regime (F8) · Regime', free: 'Banner', pro: 'Banner + size gate', elite: 'Full' },
  ...
  },
  {
    ...
    rows: [
      { key: 'N1_copilot', feature: 'AI Copilot chat (N1)', free: '5 msgs/day', pro: '50 msgs/day', elite: '200 msgs/day' },
      { key: 'scanner_lab', feature: 'AI Scanner (60+ filters w/ bull+bear parity + ML-gated patterns)', free: false, pro: true, elite: true },
  ...
  },
  {
    label: 'Trust + safety',
    rows: [
      { key: 'public_track_record', feature: 'Public /proof (track record + model accuracy)', free: true, pro: true, elite: true },
