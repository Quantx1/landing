...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        // xAI mono terminal: hairline charcoal surface, 8px radius, no glow.
        "z-0 h-full max-h-[400px] w-full rounded-sm border border-line bg-wrap font-mono text-d-text-secondary",
        className
      )}
    >
      <div className="flex flex-col gap-y-2 border-b border-line p-4">
        <div className="flex flex-row gap-x-2">
          <div className="h-2 w-2 rounded-full bg-d-text-muted/40"></div>
          <div className="h-2 w-2 rounded-full bg-d-text-muted/40"></div>
          <div className="h-2 w-2 rounded-full bg-d-text-muted/40"></div>
        </div>
      </div>
